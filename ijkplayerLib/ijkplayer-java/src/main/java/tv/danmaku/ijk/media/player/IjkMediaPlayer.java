...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public static final int FFP_PROP_FLAOT_PLAYBACK_PITCH                   = 10008;
    ...
    public void setPitch(float Pitch) {
        _setPropertyFloat(FFP_PROP_FLAOT_PLAYBACK_PITCH, Pitch);
    }

    public float getPitch(float Pitch) {
        return _getPropertyFloat(FFP_PROP_FLAOT_PLAYBACK_PITCH, .0f);
    }
    ...
    public void switchAudioTrack(int trackNums, int index) {
    		_switchAudioTrack(trackNums, index);
		}
    
    private native int _getAudioTrackNum();
    private native void _switchAudioTrack(int trackNums, int index);
