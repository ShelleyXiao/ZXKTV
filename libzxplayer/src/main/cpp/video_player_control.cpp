...
VideoPlayerControl::VideoPlayerControl(JavaJNICallback *javaJNICall, const char *url,
                                       bool onlymusic) {
...
void VideoPlayerControl::setAudioChannel(int index) {
    if (audioDecoder != NULL) {
        ...
        LOGI("audio channels = %d", channelsize)
