...
package com.zx.zxktv.ui.widget.pagelayout;
...
//        LogUtils.d("Song onLayoutChildren");
//        LogUtils.d("Song onLayoutChildren isPreLayout = " + state.isPreLayout());
//        LogUtils.d("Song onLayoutChildren isMeasuring = " + state.isMeasuring());
//        LogUtils.e("Song onLayoutChildren state = " + state);
...
//        LogUtils.d("mOffsetX = " + mOffsetX);
//        LogUtils.d("mOffsetY = " + mOffsetY);
...
//        LogUtils.d("onScrollStateChanged = " + state);
        mScrollState = state;
...
//            LogUtils.d("列 = " + col);
//
//            LogUtils.d("offsetX = " + offsetX);
//            LogUtils.d("offsetY = " + offsetY);
...
//        LogUtils.d("getPageIndexByOffset pageIndex = " + pageIndex);
        return pageIndex;
    }
